...
public class Utilities {
     ...
     */
    public static String generateRandomString(int intLength) {
        String generatedString = RandomStringUtils.randomAlphanumeric(intLength);
    ...
    public static ArrayList<Integer> getAllDates(int month, int year) {
